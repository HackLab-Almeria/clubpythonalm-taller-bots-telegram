#!/usr/bin/env python3
# -*- coding: utf-8 -*-
""" Ejemplo: 12 - Teclado Virtual con Emojis
...
teclado_virtual.row('\U000026C5','\U0000231B') #Icono nube y sol y Reloj Arena en una línea (row)
teclado_virtual.row("Ayuda") # Muestra el menú de opciones
...
def listener(mensaje_telegram):
	...
	for mensaje in mensaje_telegram:
		chatID = mensaje.chat.id # <- Se obtiene el ChatID
...
try:
	...
	telegram.send_message(chatID, opciones, None, None, markup) # Mandamos el teclado diseñado
	telegram.send_message(chat_id=chatID,parse_mode="HTML",text=opciones)
	telegram.send_message(chatID,"Pulse una opción", None, None, markup)
